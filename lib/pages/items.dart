...
import 'package:listas_de_compras/blocs/items_list_bloc.dart';
import 'package:listas_de_compras/models/Item.dart';
import 'package:listas_de_compras/widgets/ItemsList.dart';
    ...
    final content = Column(
      ...
      children: <Widget>[
        Container(
          ...
          child: Text('Lista: ' + ItemsPage.nameList,
          ...
          child: StreamBuilder<List<Map>>(
            ...
            builder: (BuildContext context, AsyncSnapshot snapshot) {
              ...
              for (Map item in items) {
                double vlr =
                    currencyToFloat(item['valor']) * item['quantidade'];
                subTotal += vlr;
              ...
              TextStyle secDarkText = TextStyle(
                  color: Layout.secondaryDark(), fontWeight: FontWeight.bold);
              TextStyle secDarkTextSelected =
                  TextStyle(color: Layout.info(), fontWeight: FontWeight.bold);
                        ...
                        children: <Widget>[
                          InkWell(
                            ...
                            child: Column(children: <Widget>[
                              ...
                              Text(qtdTotal.toString(),
                                  textScaleFactor: 1.2, style: secDarkText)
                            ]),
                          ),
                          InkWell(
                            onTap: () => itemsListBloc
                                .toggleFilter(ItemsListFilterBy.checked),
                            child: Column(children: <Widget>[
                              Text(
                                'Carrinho',
                                style: (itemsListBloc.filterBy ==
                                        ItemsListFilterBy.checked)
                                    ? secDarkTextSelected
                                    : secDarkText,
                              ),
                              Text(
                          ...
                          InkWell(
                            onTap: () => itemsListBloc
                                .toggleFilter(ItemsListFilterBy.unchecked),
                            child: Column(children: <Widget>[
                              Text(
                                'Faltando',
                                style: (itemsListBloc.filterBy ==
                                        ItemsListFilterBy.unchecked)
                                    ? secDarkTextSelected
                                    : secDarkText,
                              ),
                              Text(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 22,
                              color:
                                  isClosed ? Layout.info() : Layout.primary(),
                              fontWeight: FontWeight.bold,
                            ),
                          )
                        ],
